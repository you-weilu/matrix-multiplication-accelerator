...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_QUAD(tracep,c+60,0,"base_addr_a",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 63,0);
    VL_TRACE_DECL_QUAD(tracep,c+62,0,"base_addr_b",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 63,0);
    VL_TRACE_DECL_QUAD(tracep,c+64,0,"base_addr_c",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 63,0);
    VL_TRACE_DECL_BIT(tracep,c+66,0,"clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+67,0,"rst_n",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+68,0,"reg_go",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+69,0,"reg_m_tiles",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 7,0);
    VL_TRACE_DECL_BUS(tracep,c+70,0,"reg_n_tiles",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 7,0);
    VL_TRACE_DECL_BUS(tracep,c+71,0,"reg_k_tiles",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 7,0);
    VL_TRACE_DECL_BIT(tracep,c+72,0,"reg_done",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+73,0,"reg_base_addr_a_lo",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+74,0,"reg_base_addr_a_hi",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+75,0,"reg_base_addr_b_lo",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+76,0,"reg_base_addr_b_hi",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+77,0,"reg_base_addr_c_lo",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+78,0,"reg_base_addr_c_hi",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+79,0,"wr_addr_lat",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 5,0);
    VL_TRACE_DECL_BUS(tracep,c+80,0,"wr_data_lat",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BIT(tracep,c+81,0,"wr_commit",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+82,0,"wr_state",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BIT(tracep,c+83,0,"rd_state",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_PUSH_PREFIX(tracep, "csr_axi", VerilatedTracePrefixType::SCOPE_INTERFACE, 0, 0);
    Vtop___024root__trace_init_sub__TOP__csr_block_wrap__DOT__csr_axi__0(vlSelf, tracep);
    VL_TRACE_POP_PREFIX(tracep);
    VL_TRACE_POP_PREFIX(tracep);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__csr_block_wrap__DOT__csr_axi__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    const int c = vlSymsp->__Vm_baseCode;
    VL_TRACE_DECL_BUS(tracep,c+105,0,"ADDR_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+105,0,"DATA_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BIT(tracep,c+84,0,"aclk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+85,0,"aresetn",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+86,0,"awvalid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+87,0,"awready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+88,0,"awaddr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+89,0,"awprot",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 2,0);
    VL_TRACE_DECL_BIT(tracep,c+90,0,"wvalid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+91,0,"wready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+92,0,"wdata",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+93,0,"wstrb",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 3,0);
    VL_TRACE_DECL_BIT(tracep,c+94,0,"bvalid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+95,0,"bready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+96,0,"bresp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BIT(tracep,c+97,0,"arvalid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+98,0,"arready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+99,0,"araddr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+100,0,"arprot",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 2,0);
    VL_TRACE_DECL_BIT(tracep,c+101,0,"rvalid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BIT(tracep,c+102,0,"rready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    VL_TRACE_DECL_BUS(tracep,c+103,0,"rdata",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 31,0);
    VL_TRACE_DECL_BUS(tracep,c+104,0,"rresp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 1,0);
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+60,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__base_addr_a),64);
    bufp->fullQData(oldp+62,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__base_addr_b),64);
    bufp->fullQData(oldp+64,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__base_addr_c),64);
    bufp->fullBit(oldp+66,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__clk));
    bufp->fullBit(oldp+67,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__rst_n));
    bufp->fullBit(oldp+68,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_go));
    bufp->fullCData(oldp+69,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_m_tiles),8);
    bufp->fullCData(oldp+70,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_n_tiles),8);
    bufp->fullCData(oldp+71,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_k_tiles),8);
    bufp->fullBit(oldp+72,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_done));
    bufp->fullIData(oldp+73,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_a_lo),32);
    bufp->fullIData(oldp+74,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_a_hi),32);
    bufp->fullIData(oldp+75,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_b_lo),32);
    bufp->fullIData(oldp+76,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_b_hi),32);
    bufp->fullIData(oldp+77,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_c_lo),32);
    bufp->fullIData(oldp+78,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__reg_base_addr_c_hi),32);
    bufp->fullCData(oldp+79,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__wr_addr_lat),6);
    bufp->fullIData(oldp+80,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__wr_data_lat),32);
    bufp->fullBit(oldp+81,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__wr_commit));
    bufp->fullCData(oldp+82,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__wr_state),2);
    bufp->fullBit(oldp+83,(vlSelfRef.csr_block_wrap__DOT__dut__DOT__rd_state));
    bufp->fullBit(oldp+84,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.aclk));
    bufp->fullBit(oldp+85,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.aresetn));
    bufp->fullBit(oldp+86,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.awvalid));
    bufp->fullBit(oldp+87,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.awready));
    bufp->fullIData(oldp+88,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.awaddr),32);
    bufp->fullCData(oldp+89,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.awprot),3);
    bufp->fullBit(oldp+90,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.wvalid));
    bufp->fullBit(oldp+91,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.wready));
    bufp->fullIData(oldp+92,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.wdata),32);
    bufp->fullCData(oldp+93,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.wstrb),4);
    bufp->fullBit(oldp+94,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.bvalid));
    bufp->fullBit(oldp+95,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.bready));
    bufp->fullCData(oldp+96,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.bresp),2);
    bufp->fullBit(oldp+97,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.arvalid));
    bufp->fullBit(oldp+98,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.arready));
    bufp->fullIData(oldp+99,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.araddr),32);
    bufp->fullCData(oldp+100,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.arprot),3);
    bufp->fullBit(oldp+101,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.rvalid));
    bufp->fullBit(oldp+102,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.rready));
    bufp->fullIData(oldp+103,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.rdata),32);
    bufp->fullCData(oldp+104,(vlSymsp->TOP__csr_block_wrap__DOT__csr_axi.rresp),2);
}
