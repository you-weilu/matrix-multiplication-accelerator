...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__csr_block_wrap__DOT__csr_axi{vlSymsp->TOP.__PVT__csr_block_wrap__DOT__csr_axi}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 106);
