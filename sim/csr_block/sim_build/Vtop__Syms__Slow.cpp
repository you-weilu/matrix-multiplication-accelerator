    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_csr_block_wrap__dut->varInsert("base_addr_a", &(TOP.csr_block_wrap__DOT__dut__DOT__base_addr_a), false, VLVT_UINT64, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,63,0);
    __Vscopep_csr_block_wrap__dut->varInsert("base_addr_b", &(TOP.csr_block_wrap__DOT__dut__DOT__base_addr_b), false, VLVT_UINT64, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,63,0);
    __Vscopep_csr_block_wrap__dut->varInsert("base_addr_c", &(TOP.csr_block_wrap__DOT__dut__DOT__base_addr_c), false, VLVT_UINT64, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,63,0);
    ...
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_a_hi", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_a_hi), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_a_lo", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_a_lo), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_b_hi", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_b_hi), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_b_lo", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_b_lo), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_c_hi", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_c_hi), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_csr_block_wrap__dut->varInsert("reg_base_addr_c_lo", &(TOP.csr_block_wrap__DOT__dut__DOT__reg_base_addr_c_lo), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    ...
    __Vscopep_csr_block_wrap__dut->varInsert("wr_addr_lat", &(TOP.csr_block_wrap__DOT__dut__DOT__wr_addr_lat), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,5,0);
