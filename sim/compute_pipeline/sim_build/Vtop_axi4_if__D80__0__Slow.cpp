...
VL_ATTR_COLD void Vtop_axi4_if__D80___eval_initial__TOP__compute_pipeline_wrap__DOT__fill_weight_axi(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___eval_initial__TOP__compute_pipeline_wrap__DOT__fill_weight_axi\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.arvalid = 0U;
    vlSelfRef.arid = 0U;
    vlSelfRef.araddr = 0ULL;
    vlSelfRef.arlen = 0U;
    vlSelfRef.arsize = 0U;
    vlSelfRef.arburst = 0U;
    vlSelfRef.rready = 0U;
    vlSelfRef.arready = 0U;
    vlSelfRef.rvalid = 0U;
    vlSelfRef.rdata[0U] = 0U;
    vlSelfRef.rdata[1U] = 0U;
...
VL_ATTR_COLD void Vtop_axi4_if__D80___eval_initial__TOP__compute_pipeline_wrap__DOT__c2h_axi(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___eval_initial__TOP__compute_pipeline_wrap__DOT__c2h_axi\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.rresp = 0U;
...
VL_ATTR_COLD void Vtop_axi4_if__D80___ctor_var_reset(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___ctor_var_reset\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
