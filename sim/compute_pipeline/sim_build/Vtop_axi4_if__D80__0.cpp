...
void Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__fill_weight_axi__0(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__fill_weight_axi__0\n"); );
...
void Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__fill_act_axi__0(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__fill_act_axi__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__0(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___ico_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.rdata[0U] = (IData)(vlSymsp->TOP.compute_pipeline_wrap__DOT__u_outbuf__DOT__mem
                                  [vlSymsp->TOP.compute_pipeline_wrap__DOT__u_outbuf__DOT__beat_addr]);
    vlSelfRef.rdata[1U] = (IData)((vlSymsp->TOP.compute_pipeline_wrap__DOT__u_outbuf__DOT__mem
                                   [vlSymsp->TOP.compute_pipeline_wrap__DOT__u_outbuf__DOT__beat_addr] 
                                   >> 0x00000020U));
    vlSelfRef.rdata[2U] = 0U;
    vlSelfRef.rdata[3U] = 0U;
...
void Vtop_axi4_if__D80___nba_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__0(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___nba_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void Vtop_axi4_if__D80___nba_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__1(Vtop_axi4_if__D80* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if__D80___nba_sequent__TOP__compute_pipeline_wrap__DOT__c2h_axi__1\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
