...
VL_ATTR_COLD void Vtop_axi4_if___eval_initial__TOP__compute_pipeline_wrap__DOT__fill_weight_axi(Vtop_axi4_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if___eval_initial__TOP__compute_pipeline_wrap__DOT__fill_weight_axi\n"); );
...
VL_ATTR_COLD void Vtop_axi4_if___eval_initial__TOP__compute_pipeline_wrap__DOT__c2h_axi(Vtop_axi4_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_axi4_if___eval_initial__TOP__compute_pipeline_wrap__DOT__c2h_axi\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.rresp = 0U;
