...
#ifndef VERILATED_VTOP_AXI4_IF__D80_H_
#define VERILATED_VTOP_AXI4_IF__D80_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_axi4_if__D80 final {
  public:
    ...
    void dtor();
    VL_UNCOPYABLE(Vtop_axi4_if__D80);
