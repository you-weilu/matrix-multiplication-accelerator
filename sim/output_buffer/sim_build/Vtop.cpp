...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , buf_wen{vlSymsp->TOP.buf_wen}
    , buf_row{vlSymsp->TOP.buf_row}
    ...
    , buf_data{vlSymsp->TOP.buf_data}
    , __PVT__output_buffer_wrap__DOT__c2h_axi{vlSymsp->TOP.__PVT__output_buffer_wrap__DOT__c2h_axi}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 140);
