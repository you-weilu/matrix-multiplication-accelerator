...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , row_valid{vlSymsp->TOP.row_valid}
    , weight_buf_data{vlSymsp->TOP.weight_buf_data}
    , act_buf_data{vlSymsp->TOP.act_buf_data}
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 146);
